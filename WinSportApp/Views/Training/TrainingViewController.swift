...
private extension TrainingViewController {
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            blurView.topAnchor.constraint(equalTo: trainingLabel.bottomAnchor,
                                          constant: Constants.sixteen),
            ...
            trainingImageView.topAnchor.constraint(equalTo: blurView.topAnchor,
                                                   constant: Constants.sixteen),
            trainingImageView.leadingAnchor.constraint(equalTo: blurView.leadingAnchor,
                                                       constant: Constants.sixteen),
            trainingImageView.trailingAnchor.constraint(equalTo: blurView.trailingAnchor,
                                                        constant: -Constants.sixteen),
            ...
            trainingTextLabel.topAnchor.constraint(equalTo: trainingImageView.bottomAnchor,
                                                   constant: Constants.sixteen),
            trainingTextLabel.leadingAnchor.constraint(equalTo: blurView.leadingAnchor,
                                                       constant: Constants.sixteen),
            trainingTextLabel.trailingAnchor.constraint(equalTo: blurView.trailingAnchor,
                                                        constant: -Constants.sixteen),
